...
import click.quickclicker.fiszki.dialogs.category.SelectCategoryDialog
...
class SelectCategory(activity: Activity) : PrimaryDrawerItem() {
    ...
    init {
        ...
        val categoryToPopulate = ArrayList<click.quickclicker.fiszki.model.category.Category>().apply {
